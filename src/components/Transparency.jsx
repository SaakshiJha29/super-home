...
export default function Transparency() {
  const metrics = [
    {
      ...
      description: 'Measured across global PoPs without artificial artificial cache warmers.',
      icon: Server,
      accent: 'text-sky-400',
    },
    {
  ...
  return (
    <section id="transparency" className="py-24 bg-slate-950 relative overflow-hidden border-t border-slate-900">
      
      {/* Subtle Glow Background */}
      <div className="absolute top-1/2 left-10 -translate-y-1/2 w-96 h-96 bg-emerald-500/5 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {metrics.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="glass-panel p-6 rounded-3xl border border-slate-800/80 flex flex-col justify-between hover:border-emerald-500/30 transition-all duration-300 group"
              >
                <div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-800/60 flex items-center gap-1.5 text-[10px] font-mono text-slate-500">
        ...
        <div className="glass-panel rounded-3xl p-8 border border-slate-800 bg-gradient-to-r from-slate-900/90 via-slate-900/60 to-slate-950 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="px-5 py-3 rounded-2xl bg-slate-950 border border-slate-800 text-xs font-mono text-emerald-400 font-semibold shrink-0 flex items-center gap-2">
